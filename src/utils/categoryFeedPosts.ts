    ...
    'NFL Teams': [
      {
        id: 'nfl-team-1',
        userId: 'user-1',
        username: 'chiefs_kingdom',
        displayName: 'Chiefs Kingdom',
        content: '@KansasCityChiefs are back in Super Bowl form. The dynasty continues!',
        entityId: 100,
        entityTicker: 'KCCHI',
      ...
      },
      {
        id: 'nfl-team-2',
        userId: 'user-2',
        username: 'bills_mafia',
        displayName: 'Bills Mafia',
        content: '@BuffaloBills playoff run is looking strong. Josh Allen is unstoppable!',
        entityId: 101,
        entityTicker: 'BUFBI',
      ...
      },
      {
        id: 'nfl-team-3',
        userId: 'user-3',
        username: 'ravens_flock',
        displayName: 'Ravens Flock',
        content: '@BaltimoreRavens defense is elite. Championship caliber team right here.',
        entityId: 102,
        entityTicker: 'BALRA',
      ...
      },
      {
        ...
        username: 'bengals_fan',
        displayName: 'Bengals Fan',
        content: '@CincinnatiBengals and @KansasCityChiefs rivalry is the best in the NFL right now.',
        entityId: 103,
        entityTicker: 'CINBE',
      ...
      },
      {
        ...
        username: 'nfl_analyst',
        displayName: 'NFL Analyst',
        content: '@NFLTeams The AFC is stacked this year. Multiple teams have a real shot at the Super Bowl.',
        entityId: undefined,
        entityTicker: undefined,
        entityName: undefined,
        sentiment: 'positive',
      ...
      },
      {
        ...
        userId: 'user-6',
        username: 'dallas_fan',
        displayName: 'Dallas Fan',
        content: '@DallasCowboys are looking strong this season. The defense is finally coming together.',
        entityId: 114,
        entityTicker: 'DALCO',
      ...
      },
      {
        ...
        userId: 'user-7',
        username: 'eagles_fan',
        displayName: 'Eagles Fan',
        content: '@PhiladelphiaEagles need to step it up. The offense has been inconsistent.',
        entityId: 116,
        entityTicker: 'PHIEA',
      ...
      },
      {
        ...
        content: '@NFLTeams The trade deadline is going to be wild. So many teams are buyers this year.',
        entityId: undefined,
        entityTicker: undefined,
        entityName: undefined,
        sentiment: 'neutral',
    ...
    'NBA Teams': [
      {
        id: 'nba-team-1',
        userId: 'user-1',
        username: 'celtics_fan',
        displayName: 'Celtics Fan',
        content: '@BostonCeltics are the team to beat. Championship or bust this season!',
        entityId: 200,
        entityTicker: 'BOSCE',
      ...
      },
      {
        ...
        userId: 'user-2',
        username: 'bucks_fan',
        displayName: 'Bucks Fan',
        content: '@MilwaukeeBucks with Giannis are still the favorites. The Greek Freak is unstoppable!',
        entityId: 201,
        entityTicker: 'MILBU',
      ...
      },
      {
        ...
        username: 'nuggets_fan',
        displayName: 'Nuggets Fan',
        content: '@DenverNuggets are the defending champs for a reason. Jokic is the best player in the world.',
        entityId: 202,
        entityTicker: 'DENNU',
      ...
      },
      {
        ...
        userId: 'user-4',
        username: 'lakers_fan',
        displayName: 'Lakers Fan',
        content: '@LosAngelesLakers need to figure it out. LeBron and AD need more help.',
        entityId: 204,
        entityTicker: 'LALAK',
      ...
      },
      {
        ...
        username: 'warriors_fan',
        displayName: 'Warriors Fan',
        content: '@GoldenStateWarriors dynasty isn\'t over yet. Steph Curry still has it!',
        entityId: 205,
        entityTicker: 'GSWAR',
      ...
      },
      {
        ...
        username: 'nba_analyst',
        displayName: 'NBA Analyst',
        content: '@NBATeams The Eastern Conference is wide open. Multiple teams have a real shot at the title.',
        entityId: undefined,
        entityTicker: undefined,
        entityName: undefined,
        sentiment: 'positive',
      ...
      },
      {
        ...
        userId: 'user-16',
        username: 'suns_fan',
        displayName: 'Suns Fan',
        content: '@PhoenixSuns are heating up. The Big 3 is finally clicking.',
        entityId: 203,
        entityTicker: 'PHOEN',
      ...
      },
      {
        ...
        username: 'mavs_fan',
        displayName: 'Mavs Fan',
        content: '@DallasMavericks need to make a move. Luka can\'t do it all by himself.',
        entityId: 209,
        entityTicker: 'DALMA',
      ...
      },
      {
        ...
        content: '@NBATeams The trade deadline is going to shake things up. Contenders are loading up.',
        entityId: undefined,
        entityTicker: undefined,
        entityName: undefined,
        sentiment: 'neutral',
    ...
    'College Basketball Teams': [
      {
        id: 'cbb-team-1',
        userId: 'user-1',
        username: 'college_hoops_fan',
        displayName: 'College Hoops Fan',
        content: '@CollegeBasketballTeams March Madness is going to be insane this year. The talent level is through the roof!',
        entityId: undefined,
        entityTicker: undefined,
        entityName: undefined,
        sentiment: 'positive',
      ...
      },
      {
        ...
        userId: 'user-2',
        username: 'ncaa_fan',
        displayName: 'NCAA Fan',
        content: '@CollegeBasketballTeams The transfer portal has changed everything. Teams are loading up on talent.',
        entityId: undefined,
        entityTicker: undefined,
        entityName: undefined,
        sentiment: 'neutral',
