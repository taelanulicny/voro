...
const generateMockNews = (): NewsArticle[] => {
  const newsTemplates = [
    ...
    // Bitcoin Halving (ID: 4)
    {
      title: 'Bitcoin Halving 2028: Miners Prepare for Major Supply Shock',
      summary: 'Mining operations worldwide gear up for the next Bitcoin halving event expected to impact supply dynamics.',
      source: 'CoinDesk',
      category: 'Crypto' as const,
      entityId: 4,
      entityTicker: 'BTCHLV',
      entityName: 'Bitcoin Halving 2028',
      sentiment: 'bullish' as const,
      sentimentScore: 75,
      impactLevel: 'high' as const,
    ...
    // Solana (ID: 9)
    {
      ...
      summary: 'Blockchain platform handles unprecedented activity, demonstrating scalability and growing adoption.',
      source: 'CoinTelegraph',
      category: 'Crypto' as const,
      entityId: 9,
      entityTicker: 'SOLANA',
      entityName: 'Solana Ecosystem',
      sentiment: 'bullish' as const,
      sentimentScore: 72,
      impactLevel: 'high' as const,
      tags: ['Solana', 'Blockchain', 'Volume'],
      isBreaking: false,
    },
    // General market news
    {
      title: 'Crypto Market Rally Continues as Institutional Adoption Grows',
      summary: 'Major financial institutions increase cryptocurrency holdings, driving sustained market momentum.',
      source: 'Financial Times',
      category: 'Crypto' as const,
      sentiment: 'bullish' as const,
      sentimentScore: 68,
      impactLevel: 'high' as const,
      tags: ['Crypto', 'Institutional', 'Adoption'],
      isBreaking: false,
    },
    {
