...
const EntityPage: React.FC<EntityPageProps> = ({ entityId, categoryName, onBack }) => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'chart' | 'news' | 'social' | 'trades'>('social');
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-white px-4 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          ...
          <h1 className="text-lg font-bold text-gray-900">{entity.ticker}</h1>
          <div className="w-8"></div>
        </div>
      </div>

      {/* Entity Info Header - Webull Style */}
      <div className="bg-white px-4 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900">{entity.ticker}</h2>
      ...
      {/* Navigation Tabs - Webull Style */}
      <div className="bg-white border-b border-gray-200">
        <div className="flex overflow-x-auto">
          {[
            { id: 'chart', label: 'Chart' },
            { id: 'news', label: 'News', hasNotification: true },
            { id: 'social', label: 'Feeds', hasNotification: true },
            ...
            <button
              ...
              className={`px-4 py-3 text-sm font-medium whitespace-nowrap border-b-2 relative ${
                activeTab === tab.id
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="text-lg font-semibold">${formatNumber(entity.marketCap)}</div>
                </div>
                <div>
                  <div className="text-sm text-gray-600">24H Volume</div>
                  <div className="text-lg font-semibold">{formatNumber(entity.volume)}</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white border-t border-gray-200">
              <div className="h-20 p-4">
                <div className="h-full bg-gray-50 rounded-lg flex items-center justify-center">
                  <div className="text-gray-500 text-sm">Volume Chart</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'trades' && (
          <div className="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <div className="divide-y divide-gray-200">
              {entity.tradingHistory.slice(0, 20).map((trade) => (
                <div key={trade.id} className="px-4 py-3 flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <div className="text-sm text-gray-900">{formatNumber(trade.volume)}</div>
